...
const personalMessage = (message, name) => console.log(message() + name);
...
// =============================================
// 3. COMMON HIGHER ORDER FUNCTIONS/METHODS IN JAVASCRIPT
// =============================================
...
const allLongWords = words3.every((word) => word.length > 2);
