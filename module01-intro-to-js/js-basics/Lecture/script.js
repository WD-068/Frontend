...
// With parameters
const multiply = (numberA, numberB, numberC) => {
  return numberA * numberB - numberC;
};
const multNum = multiply(5, 6, 20);
...
console.log(10 === 10 && 0 === "0"); // false (At least one condition is false)
...
console.log(10 === 10 || 0 === "0"); // true (At least one condition is true)
...
for (let i = 0; i < 6; i++) {
  ...
  console.log(i); // Outputs: 0, 1, 3, 4, 5
}
